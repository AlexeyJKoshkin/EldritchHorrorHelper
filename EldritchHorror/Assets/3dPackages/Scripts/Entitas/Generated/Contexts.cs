...
public partial class Contexts : Entitas.IContexts {
    ...
    public CharactersContext characters { get; set; }
    public EldritchWorldMapContext eldritchWorldMap { get; set; }

    public Entitas.IContext[] allContexts { get { return new Entitas.IContext [] { characters, eldritchWorldMap }; } }

    public Contexts() {
        characters = new CharactersContext();
...
public partial class Contexts {
    ...
    public void InitializeContextObservers() {
        try {
            CreateContextObserver(characters);
