...
namespace GameKit.Editor
{
    ...
    {
        private readonly ISubScriptableFactory _provider;
        ...
        {
            _provider = factory ?? new DefaultSubScriptableFactory(typeof(T));
            _list = CreateReorderable(serializedObject, property, label);
            _list.onAddCallback += (list) => _provider.DrawCreateNewElementMenu(this, OnAddCallbackHandler);
